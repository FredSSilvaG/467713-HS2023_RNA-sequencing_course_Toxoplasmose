...
ANNOTATION_FOLDER=/data/users/fsilvagutierrez/Cluster_1/IBU_Cluster_Analysis/Reference 

#Define the folder for output
OUTPUT_FOLDER=/data/users/fsilvagutierrez/Cluster_1/IBU_Cluster_Analysis/04_counts 
...
BAM_FILES=/data/users/fsilvagutierrez/Cluster_1/IBU_Cluster_Analysis/03_mapping/*mappedReads_sorted.bam
